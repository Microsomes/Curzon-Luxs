<template>
    ...
    <div style="overflow:hidden">
        <navi></navi>
            ...
            <div class="row">
                <div class="col">
                    <h2 class="display-1 text-muted" style="text-align:Center">Terms of use</h2>
                </div>
            </div>
            <div class="container">
                <div class="row">
...
Please read these Terms of Use ("Terms", "Terms of Use") carefully before using the http://www.mywebsite.com (change this) website and the My Mobile App (change this) mobile application (the "Service") operated by My Company (change this) ("us", "we", or "our").
...
The Purchases section is for businesses that sell online (physical or digital). For the full disclosure section or for a “SaaS” section, create your own Terms of Use.
